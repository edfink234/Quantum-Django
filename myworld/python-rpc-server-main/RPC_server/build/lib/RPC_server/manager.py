...
class AsyncJSONRPCResponseManager:
    ...
    def get_response_for_request(self, request: JSONRPC20Request) -> Optional[JSONRPC20Response]:
    ...
    def get_response_for_request_body(self, request_body) -> Optional[JSONRPC20Response]:
        ...
        try:
            ...
            return self.get_response_for_request(request)

    def get_response_for_payload(self, payload: str) -> Optional[Union[JSONRPC20Response, JSONRPC20BatchResponse]]:
        """Top level handler
    ...
    def get_payload_for_payload(self, payload: str) -> str:
        response = self.get_response_for_payload(payload)
