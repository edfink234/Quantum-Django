...
#    user_db = db.posts.find_one({"user": username})
    ...
    possibleHTMLelements = {"users_html": {"status":True, "html": r'<div class="col-sm" id = "users_html"> gui_elements </div>', "defaultCoordinates": (-11, 639)}, "dropdownMenuButtonChanOutput": {"status":True, "html": r'<div class="col-sm" align = "center" id="dropdownMenuButtonChanOutput" draggable = "true"><button type="button" class="btn btn-info" onclick="ChannelSetter();" clicked="true">Read Temperature</button></div>', "defaultCoordinates": (296, 457)}, "dropdownMenuButtonSetFreqAmplChanPhaseOutput": {"status":True, "html": '<div class="col-sm" align = "center" id="dropdownMenuButtonSetFreqAmplChanPhaseOutput" draggable = "true"><button type="button" class="btn btn-info" onclick="FreqAmplChanPhaseSetter();" clicked="true">Set Output</button></div>', "defaultCoordinates": (-11, 457)}, "Signal": {"status":True, "html": '<div class="col-sm" align = "center" draggable = "true" id = "Signal"><button type="button" class="btn btn-warning" onclick="SendBack(\'{&quot;function&quot;: &quot;signal&quot;, &quot;instructions&quot;: &quot;Hi friend!!&quot;}\')">Signal!</button></div>', "defaultCoordinates": (398.328125, 371)}, "Stop": {"status":True, "html": '<div class="col-sm" align = "center" draggable = "true" id = "Stop"><button type="button" class="btn btn-danger" onclick="Stop(); PauseAnimations();">Stop!</button></div>', "defaultCoordinates": (193.6640625, 371)}, "Start": {"status":True, "html": '<div class="col-sm" align = "center" draggable = "true" id = "Start"><button type="button" class="btn btn-success" onclick="Start(); ResumeAnimations();">Start!</button></div>', "defaultCoordinates": (-11, 371)}, "time_diff": {"status":True, "html": '<div class="col-sm" align = "center" draggable = "true" id = "time_diff" draggable = "true"><label for="timediff" class = "foo">&nbsp Time Difference for Camera Data (seconds):&nbsp</label><input type = "text" id="timediff" name = "timediff" readonly></div>', "defaultCoordinates": (-11, 288)}, "voltages": {"status":True, "html": '<div class="col-sm" id="voltages" align = "center" draggable="true"></div>', "defaultCoordinates": (-11, 264)}, "heat-map-line-graph-show": {"status":True, "html": r'<div class="col-sm" id="heat-map-line-graph-show" align = "center" draggable="true"></div>', "defaultCoordinates": (-11, 216)}}
