...
def index(request): #Corresponds to myfirst.html
    ...
    if user_db:
        ...
        print(user_db.get("functionDict"))
...
#        print(activated_channels, type(activated_channels[0]))
    ...
    return render(request, r"myfirst.html", context = {'gui_elements' : html_string, 'channelsActivated' : activated_channels, 'functionDict' : json.dumps(user_db.get("functionDict"))})
