    ...
    async def listen(self):
        ...
        while True:
            try:
                ...
                #print(data)
                await self.channel_layer.group_send("ZMQ",{"type": "chat.message", "text": [str(i) for i in data]}) # TODO: is it possible to send the messages without converting to string?
